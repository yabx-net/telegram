 ...
 */
final class InputRichBlockPullQuotation extends InputRichBlock {
     ...
     * @var string
     */
    protected string $type = 'pullquote';
    ...
    public static function fromArray(array $data): InputRichBlockPullQuotation {
        $instance = new self();
        if (isset($data['type'])) {
