...
final class RichTextBankCardNumber extends RichText {
    ...
    protected string $type = 'bank_card_number';

    protected mixed $text = null;

    protected ?string $bankCardNumber = null;
    ...
    public static function fromArray(array $data): RichTextBankCardNumber {
        $instance = new self();
        if (isset($data['type'])) {
        ...
        if (isset($data['bank_card_number'])) {
            $instance->bankCardNumber = $data['bank_card_number'];
        }
        return $instance;
    }
    ...
    public function setBankCardNumber(?string $value): self {
